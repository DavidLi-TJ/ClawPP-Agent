...
#include "infrastructure/runner/shell_command_runner.h"
...
QJsonObject handleShell(const QJsonObject& params) {
    ...
    const clawpp::ShellLaunchSpec spec = clawpp::buildShellLaunchSpec(command);
    ...
    QString stderrText = clawpp::normalizeShellStderr(
        exitCode,
